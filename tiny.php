...
$auth_users = array(
    'admin' => '$2y$10$St2HwDvBTi/iGoUwY5LLP.bafEbUTERG/WXk2S.qbgzy0hgzHdjui', //admin@123
...
if ($use_auth) {
    if (isset($_SESSION[FM_SESSION_ID]['logged'], $auth_users[$_SESSION[FM_SESSION_ID]['logged']])) {
        ...
        ?>
        <section class="h-100">
            <div class="1container h-100">
                <div class="1row justify-content-md-center h-100">
                    <div class="1card-wrapper">
                        <div class="1card fat <?php echo fm_get_theme(); ?>">
...
<body class="fm-login-page1 <?php echo (FM_THEME == "dark") ? 'theme-dark' : ''; ?>">
